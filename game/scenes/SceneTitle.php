<?php
	...
	function startScene(){
		...
		addEvent("confirm","keynewpress_13" ,'[["if",  [[["select_index",-1 ,function(ix){ return ix == 1;}]]]  ], ["change_resolution", function(){ return 1280;}, function(){ return 960;}], ["else"], ["execute_function", function(){alert(1);}], ["end"]]', "[]", "win");
		addTriggerKey(13);
	}
